...
def get_contribution_room(
    ...
    tfsa_limit_cents = tfsa_annual_limit(year) * 100  # $7000 -> 700000 cents
    rrsp_max_cents = rrsp_max_annual(year) * 100
    ...
    fhsa_annual = FHSA_ANNUAL_LIMIT * 100
    fhsa_lifetime = FHSA_LIFETIME_LIMIT * 100
    ...
    return {
        ...
        "tfsa": {
            ...
            "note": "Actual TFSA room from CRA My Account (cumulative); this is annual limit only.",
        },
        "rrsp": {
